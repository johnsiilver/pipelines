...
func (m *RequestGroupResp) CloneVT() *RequestGroupResp {
	...
	if m.Message != nil {
		r.Message = m.Message.(interface {
			CloneVT() isRequestGroupResp_Message
		}).CloneVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *RequestGroupResp_Data) CloneVT() isRequestGroupResp_Message {
	if m == nil {
		return (*RequestGroupResp_Data)(nil)
	}
	r := &RequestGroupResp_Data{
		Data: m.Data.CloneVT(),
	}
	return r
}
...
func (this *RequestGroupResp) EqualVT(that *RequestGroupResp) bool {
	...
	if this.Message == nil && that.Message != nil {
		...
		if !this.Message.(interface {
			EqualVT(isRequestGroupResp_Message) bool
		}).EqualVT(that.Message) {
			return false
		}
	}
...
func (this *RequestGroupResp_Data) EqualVT(thatIface isRequestGroupResp_Message) bool {
	that, ok := thatIface.(*RequestGroupResp_Data)
	if !ok {
		return false
	}
	if this == that {
...
var Worker_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/johnsiilver/pipelines/stagedpipe/distrib/nodes/worker/proto/worker.proto",
}
...
func (m *RequestGroupResp_Data) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RequestGroupResp_Data) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Data != nil {
		size, err := m.Data.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *RequestGroupResp) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.Message.(*RequestGroupResp_Data); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *RequestGroupResp_Data) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *RequestGroupResp_Data) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Data != nil {
		size, err := m.Data.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
...
func (m *RequestGroupResp_Data) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestGroupReq) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if oneof, ok := m.Message.(*RequestGroupReq_Data); ok {
...
func (m *RequestGroupResp) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Message.(*RequestGroupResp_Data); ok {
				if err := oneof.Data.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.Message = &RequestGroupResp_Data{Data: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
